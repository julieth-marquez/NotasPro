...
//Insertar Docente 
 	 public function creardocen($Nombredocen,$Apellidodocen,$Documentodocen,$Correodocen,$Materiadocen,$Notasdocen)
 	 {
 	 	$statement = $this->db->prepare("INSERT INTO docentes (Nombredoc, Apellidodoc, Documentodoc, Correodoc, Materiadoc, Notasmate )values(:Nombredocen,:Apellidodocen, :Documentodocen, :Correodocen, :Materiadocen, :Notasdocen )");
